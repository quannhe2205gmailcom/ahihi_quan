            ...
            <div class="col-4"  style="background: #eee;">
                ...
                <tr>
                                                    ...
                                                    <tr>
                                                            ...
                                                            <td style="padding-left: 10px;"><b>Thời gian đăng: </b><span style="color:  #ff9900;"><?php echo $getdata[7]; ?></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td> <i class="fas fa-plane-departure"></i></td>
                                                            <td style="padding-left: 10px;"><b>Thời gian mở cửa:  </b> <span style="color:  #ff9900;"><?php echo $getdata[9]; ?></span></td>
                                                        </tr>
                                                        <tr>
                                                                <td> <i class="fas fa-plane-arrival"></i></td>
                                                                <td style="padding-left: 10px;"><b>Thời gian đóng cửa: </b><span style="color:  #ff9900;"><?php echo $getdata[10]; ?></span></td>
                                                            </tr>
                </table>
